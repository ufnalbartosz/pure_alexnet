...
network = conv_2d(network, 256, 3, activation='relu', name='conv2_3_3')
network = conv_2d(network, 256, 3, activation='relu', name='conv3_3_3')
...
network = fully_connected(
    network, 4096, activation='relu', name='fully_connected_1_relu')
network = dropout(network, 0.5, name='dropout_1_05')
network = fully_connected(
    network, 4096, activation='relu', name='fully_connected_2_relu')
